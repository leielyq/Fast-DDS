        ...
        const ReaderProxyData& rdata)
{
    ...
    SystemInfo::measure_rss_usage(rdata.guid(), "begin StatefulWriter::matched_reader_add ");
    ...
    SystemInfo::measure_rss_usage(rdata.guid(), "end   StatefulWriter::matched_reader_add ");
    return true;
}
        ...
        const GUID_t& reader_guid)
{
    ...
    SystemInfo::measure_rss_usage(reader_guid, "begin StatefulWriter::matched_reader_remove ");
    ...
    SystemInfo::measure_rss_usage(reader_guid, "end   StatefulWriter::matched_reader_remove ");
    return false;
}
