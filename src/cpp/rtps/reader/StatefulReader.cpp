        ...
        const WriterProxyData& wdata)
{
...

    {
        ...
        SystemInfo::measure_rss_usage(wdata.guid(), "begin StatefulReader::matched_writer_add ");
        ...
        bool removed_by_lease)
{
    ...
    SystemInfo::measure_rss_usage(writer_guid, "begin StatefulReader::matched_writer_remove ");
    ...
    SystemInfo::measure_rss_usage(writer_guid, "end   StatefulReader::matched_writer_remove ");
